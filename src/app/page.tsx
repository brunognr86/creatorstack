    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
            Crie mais conteudo em <span className="text-violet-600">menos tempo</span>
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
            A plataforma tudo-em-um para criadores de conteudo. Gere scripts,
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-gray-500">
            <div className="flex items-center gap-1"><Check className="h-4 w-4 text-green-500" />Sem cartao de credito</div>
            <div className="flex items-center gap-1"><Check className="h-4 w-4 text-green-500" />7 dias gratis</div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">Voce passa mais tempo planejando do que criando?</h2>
          <p className="text-center text-gray-600 mb-12">A realidade de quem cria conteudo hoje:</p>
      ...
      <section id="funcionalidades" className="py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">Tudo que voce precisa em uma so plataforma</h2>
          <p className="text-center text-gray-600 mb-12">Ferramentas poderosas para cada etapa da criacao de conteudo</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Sparkles, title: "Gerador de Conteudo com IA", desc: "Scripts para video, legendas para posts, ideias criativas e hashtags otimizadas. Tudo em segundos." },
              ...
              { icon: BarChart3, title: "Analytics Avancado", desc: "Acompanhe o desempenho do seu conteudo. Identifique o que funciona e otimize sua estrategia." },
              { icon: Rocket, title: "Automacoes", desc: "Conecte com suas ferramentas favoritas. Automatize tarefas repetitivas e ganhe tempo." },
              { icon: Brain, title: "IA que Aprende com Voce", desc: "Quanto mais voce usa, mais a IA entende seu estilo e entrega resultados personalizados." },
            ].map((f, i) => (
      ...
      <section id="depoimentos" className="py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Ana Carolina", role: "Criadora de Conteudo, 45k seguidores", text: "Eu passava 4 horas por dia criando conteudo. Com o CreatorStack, faco em 1 hora. Meu faturamento dobrou em 3 meses.", stars: 5 },
              { name: "Pedro Mendes", role: "YouTuber, 120k inscritos", text: "Nunca mais fiquei sem ideias de video. O gerador de scripts e incrivel. Meu canal cresceu 150% desde que comecei a usar.", stars: 5 },
              { name: "Marina Silva", role: "Social Media Manager", text: "Gerencio 12 contas de clientes. Sem essa ferramenta seria impossivel. A automacao de publicacao salvou minha sanidade mental.", stars: 5 },
            ].map((t, i) => (
      ...
      <section id="precos" className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12">Comece gratis. Escale quando estiver pronto.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Free", price: "R$ 0", period: "para sempre", features: ["10 geracoes de conteudo/mes", "5 templates basicos", "Calendario editorial simples", "Suporte por email"], highlight: false, cta: "Comecar Gratis" },
              { name: "Starter", price: "R$ 29", period: "/mes", features: ["100 geracoes de conteudo/mes", "50+ templates profissionais", "Calendario editorial completo", "Analytics avancado", "Automacoes basicas", "Suporte prioritario"], highlight: true, cta: "Assinar Starter" },
              { name: "Pro", price: "R$ 79", period: "/mes", features: ["Geracoes ILIMITADAS", "200+ templates premium", "Todas as automacoes", "API access", "Analytics em tempo real", "Suporte VIP (2h)"], highlight: false, cta: "Assinar Pro" },
            ].map((plan, i) => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              { q: "Preciso de cartao de credito para comecar?", a: "Nao! Voce pode comecar com o plano Free sem informar nenhum dado de pagamento. So precisara quando quiser fazer upgrade para um plano pago." },
              { q: "Posso cancelar a qualquer momento?", a: "Sim, voce pode cancelar sua assinatura a qualquer momento. Nao ha contratos de fidelidade nem multas de cancelamento." },
              { q: "Como funciona a garantia de 7 dias?", a: "Se voce nao ficar satisfeito nos primeiros 7 dias, devolvemos 100% do valor pago. Basta enviar um email para suporte." },
              { q: "O conteudo gerado e original?", a: "Sim! Nossa IA cria conteudo unico e original para cada usuario. Nao e copia de nada que ja exista." },
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm text-gray-500 mt-4">Sem cartao de credito. Sem compromisso.</p>
        </div>
      </section>
